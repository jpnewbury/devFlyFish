...
export default function Movies({ movies: patterns }) {
  return (
    <main className="container">
      <Header title="Fly Box - Fuzzy Nymphs" background="rainbow" />
      <BugbarNav />
      <HeaderSlug
        title="Fuzzy Nymphs"
        image="/optimized_icons/dubbed32.svg"
        height="120px"
        width="150px"
        alt="pellet flies"
        content="Fuzzy nymphs are best suited for extended drifts from slow to medium fast water (walking speed) at all depths. Properly dressed, the fuzzy nature of these patterns adds to flies bouyouncy and animation."
      />

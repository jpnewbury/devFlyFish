        ...
        <section className="section1">
          <div>
            <span className="first-letter">
              <p>
                Welcome to the new Angling Arts website focuses on fly fishing
                and tying with an emphasis on tactical style nymphs. If you are
                a retrning guest, you will notice a new feature to the website
                called the "Bug Bar" where the fly patterns listed on this
                website can be associated with a nymph type and the suggested
                patterns you can choose. I hope that this relationship with the
                natural and our imitations serve to inspire the curious angler
                into turning over some stones in your favorite stream and
